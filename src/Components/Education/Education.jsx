        ...
        <div>
            ...
            <ul className="timeline text-white flex justify-center mt-5 border-2 border-white w-max mx-auto px-28 py-2">
                ...
                <li>
                    ...
                    <div className="timeline-end timeline-box text-black">SSC</div>
                    <hr />
                </li>
                <li>
                    <hr />
                    ...
                    <div className="timeline-end timeline-box text-black">HSC</div>
                    <hr />
                </li>
                <li>
                    <hr />
                    ...
                    <div className="timeline-end timeline-box text-black">Honours</div>
                </li>
            </ul>
        </div>
    );
